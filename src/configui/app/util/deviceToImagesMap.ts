...
export const DeviceImage = new Map<DeviceType, { image: string; padding: string }>([
  ...
  [DeviceType.INDOOR_PT_CAMERA_1080, { image: 'indoorcamp24_small.jpg', padding: '0px' }],
  ...
  [DeviceType.SOLO_CAMERA_SPOTLIGHT_1080, { image: 'solooutdoorcamc24_large.jpg', padding: '0px' }],
  [DeviceType.SOLO_CAMERA_SPOTLIGHT_2K, { image: 'solooutdoorcamc24_large.jpg', padding: '0px' }],
  ...
  [DeviceType.DOORBELL_SOLO, { image: 'batterydoorbell2k_large.jpg', padding: '0px' }],
  [DeviceType.INDOOR_COST_DOWN_CAMERA, { image: 'indoorcammini_large', padding: '0px' }],
